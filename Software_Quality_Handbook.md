...
Break down larger tasks: When faced with a large task, it can be overwhelming to know where to start. One effective method is to break the task down into smaller, more manageable pieces. For example, if you can break a big task into multiple smaller pieces, they become available for others to assist, the helps the cohesion among the team and allows developers to be more confident in their changes as they are more granular.

Roughly estimate items further down the backlog: In agile project management, the backlog is a prioritized list of tasks that need to be completed. When estimating the time and effort required for each task, it's important to also consider the items further down the backlog. This can help you avoid underestimating the time required for later tasks, which could cause delays in the project. 

3 amigos: This approach involves including a developer, tester, and business analyst in project meetings to ensure that all perspectives are considered. Additionally, full vertical slice meetings bring together the front-end and back-end developers to ensure that the full feature is considered from end to end. These allow for a broader understanding of the feature in question and allows the team to make more informed decisions on their best course of action.

"Just enough" documentation: In agile development, documentation should be kept to a minimum, focusing only on what is necessary for the project. This approach can help avoid wasting time on documentation that is not needed or may become obsolete. 

https://blog.trello.com/microproductivity-break-tasks-into-smaller-steps#:~:text=%E2%80%9CBreaking%20tasks%20down%20helps%20us,workplace%20productivity%20coach%20and%20speaker.

https://plan.io/blog/technical-documentation/

https://www.agilealliance.org/glossary/three-amigos/

https://www.techrepublic.com/article/10-things-you-can-do-to-create-better-documentation/
